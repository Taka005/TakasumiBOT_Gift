...
<html lang="ja">
    <head>
        ...
        <meta property="og:title" content="無効なギフトコード" />
        <meta property="og:description" content="ギフトが送られてきましたが、どうやら有効ではないようです..." />
    ...
    <body>
	    ...
	    <main>
            <div class="info card text-center">
                <div class="card-body">
                    <h1 class="card-title">このギフトは無効です</h1>
                    <p class="card-text">ギフトが送られてきましたが、どうやら有効ではないようです</p>
                </div>
            </div>
	    </main>
